...
function Reports() {
  ...
  const handleGenerateReport = async () => {
    if (!selectedTemplate || !reportParams.startDate || !reportParams.endDate) {
      alert("Please select a report template and both start and end dates.");
      return;
    }
    ...
    console.log("Start Date (ISO):", reportParams.startDate.toISOString());
    console.log("End Date (ISO):", reportParams.endDate.toISOString());
